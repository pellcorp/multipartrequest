 ...
 */
package com.pellcorp.multipartrequest.commons.fileupload;

import java.util.HashMap;
import java.util.Map;

/**
 * A simple parser intended to parse sequences of name/value pairs. Parameter values are exptected to be
 * enclosed in quotes if they contain unsafe characters, such as '=' characters or separators. Parameter
 * values are optional and can be omitted.
 * <p>
...
public class ParameterParser {
    ...
    /**
     * A helper method to process the parsed token. This method removes leading and trailing blanks as well as
     * enclosing quotation marks, when necessary.
     * 
     ...
     * 
     * @param terminators the array of terminating characters. Any of these characters when encountered
    ...
    /**
     * Returns <tt>true</tt> if parameter names are to be converted to lower case when name/value pairs are
     * parsed.
     * 
     * @return <tt>true</tt> if parameter names are to be converted to lower case when name/value pairs are
     *         parsed. Otherwise returns <tt>false</tt>
     */
     ...
     * 
     * @param b <tt>true</tt> if parameter names are to be converted to lower case when name/value pairs are
     *            parsed. <tt>false</tt> otherwise.
     */
